...
INSERT INTO ACTIVITY_TYPE (ACTIVITY_TYPE_CODE, ACTIVITY_TYPE_NAME, DURATION, COLOR, IS_ENABLED, AVAILABLE_TIME_SLOT) 
	VALUES (101, 'Installation', 3, '#1abc9c', true, '11-16');
...
CREATE TABLE IF NOT EXISTS RESOURCE (
	...
	FOREIGN KEY (WORK_SKILL) REFERENCES ACTIVITY_TYPE(ACTIVITY_TYPE_CODE)
);


INSERT INTO RESOURCE (RESOURCE_ID, RESOURCE_NAME, USERNAME, PASSWORD, SUPERVISOR_ID, START_DATE, END_DATE) 
	VALUES (201, 'Johny', 'johny', 'Oracle123@', NULL, DATE('2020-01-07'), 
		DATE('2023-01-07'), 101);
...
INSERT INTO INVENTORY (INVENTORY_ID, INVENTORY_TYPE, MODEL, QUANTITY, SERIAL_NUMBER) 
	VALUES (301, 'ScrewDriver', 'A314', 3, 'B227');
